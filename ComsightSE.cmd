@echo off
rem License key is CSE_PJF5G4DAZ5R3

set csedir=%cd%
set msgcount=0
set license_attempts=0

if not exist cse_configversion3.txt (
  cls
  color 0f
  ...
  if not exist cse_configversion3.txt (
    aaaa > cse_configversion3.txt
    echo Comsight Security Essentials settings - DO NOT CHANGE THIS FILE > cse_configversion3.txt
    echo Version Of Configuration Files 3 >> cse_configversion3.txt
  )
  if not exist cse_lkused1.txt (
    aaaa > cse_lkused1.txt
    echo Comsight Security Essentials settings - DO NOT CHANGE THIS FILE > cse_lkused1.txt
    echo License Key not used >> cse_lkused1.txt
  )
  if not exist cse_autoaction2.txt (
    aaaa > cse_autoaction2.txt
    echo Comsight Security Essentials settings - DO NOT CHANGE THIS FILE > cse_autoaction2.txt
    echo Automatic Action >> cse_autoaction2.txt
    echo None >> cse_autoaction2.txt
  ) 
  if not exist cse_gendetect1.txt (
    aaaa > cse_gendetect1.txt
    echo Comsight Security Essentials settings - DO NOT CHANGE THIS FILE > cse_gendetect1.txt
    echo Piracy not detected >> cse_gendetect1.txt  
  )
  cls
  echo Comsight Security Essentials
  echo.
...
rem if not exist cse_analytics1.txt (
rem   set /a msgcount=msgcount+1
rem )
find /i /c "License Key not used" cse_lkused1.txt >NUL
if %errorlevel% equ 1 goto start

:license_key
  cls
  color 0f
  title License Key - Comsight Security Essentials
  echo Comsight Security Essentials
  echo.
  echo Making you safe
  echo.
  ...
  if "%check_key%" == "ca 2f a9 74 9b 7c 75 3d c0 cb a9 30 05 2d 13 da" (
    aaaa > cse_lkused1.txt
    echo Comsight Security Essentials settings - DO NOT CHANGE THIS FILE > cse_lkused1.txt
    echo License Key used >> cse_lkused1.txt
    aaaa > cse_lkinserted1.txt
    echo Comsight Security Essentials settings - DO NOT CHANGE THIS FILE > cse_lkinserted1.txt
    echo License Key inserted >> cse_lkinserted1.txt
...
:start
  cd %csedir%
  find /i /c "Piracy not detected" cse_gendetect1.txt > NUL
  if %errorlevel% equ 1 goto antipiracy
  find /i /c "License Key used" cse_lkused1.txt > NUL
  if %errorlevel% equ 0 (
    if not exist cse_lkinserted1.txt goto antipiracy
  )
  cls
  color 0f
...
:settings_action
  ...
  if /i "%choice%" == "delete" (
    ...
    echo Comsight Security Essentials settings - DO NOT CHANGE THIS FILE > cse_autoaction2.txt
    echo Automatic action >> cse_autoaction2.txt
    echo Delete >> cse_autoaction2.txt
  ...
  if /i "%choice%" == "quarantine" (
    ...
    echo Comsight Security Essentials settings - DO NOT CHANGE THIS FILE > cse_autoaction2.txt
    echo Automatic action >> cse_autoaction2.txt
    echo Quarantine >> cse_autoaction2.txt
    goto settings_action_when
  )
  if /i "%choice%" == "none" (
    echo Comsight Security Essentials settings - DO NOT CHANGE THIS FILE > cse_autoaction2.txt
...
:settings_action_when
  ...
  if /i "%choice%" == "md5" (
    echo MD5 >> cse_autoaction2.txt
    echo Successfully setted.
    pause
    goto settings_action
  )
  if /i "%choice%" == "behavior" (
    echo Behavior >> cse_autoaction2.txt
    echo Successfully setted.
    pause
    goto settings_action
  )
  if /i "%choice%" == "all" (
    echo All >> cse_autoaction2.txt
    echo Successfully setted.
    pause
    goto settings_action
  )
...
:settings_analytics_on
  ...
  echo Comsight Security Essentials settings - DO NOT CHANGE THIS FILE > cse_analytics1.txt
  echo Analytics On >> cse_analytics1.txt
  echo %email% >> cse_analytics1.txt
  echo %smtp% >> cse_analytics1.txt
...
:antipiracy
  ...
  aaaa > cse_gendetect1.txt
  echo Comsight Security Essentials settings - DO NOT CHANGE THIS FILE > cse_gendetect1.txt
  echo Piracy detected >> cse_gendetect1.txt 
  cls
  color cf
  echo.
  echo WAIT A MINUTE...
...
:md5_threat
  ...
  echo.
  find /i /c "Behavior" cse_autoaction2.txt >NUL
  if %errorlevel% equ 0 (
    set /p choice="Enter your choice: "
  ...
  find /i /c "None" cse_autoaction2.txt >NUL
  if %errorlevel% equ 0 (
    set /p choice="Enter your choice: "
    if /i "%choice%" == "delete" goto delete
    if /i "%choice%" == "ignore" goto ignore
  ...
  find /i /c "Delete" cse_autoaction2.txt >NUL
  if %errorlevel% equ 0 (
    del %file%
  ...
  find /i /c "Quarantine" cse_autoaction2.txt >NUL
  if %errorlevel% equ 0 (
    cd %csedir%
    if not exist quarant\ mkdir quarant
  ...
  echo An error occured at cse_autoaction2.txt.
...
:decrypt
  ...
  del threat.txt
  echo If nothing happened, Comsight Security Essentials doesn't know how to decrypt your files.
  pause
  goto md5_threat
...
:behavior_threat
 rem if exist cse_analytics1.txt (
 rem   for /f "tokens=1*delims=:" %%G in ('findstr /n "^" cse_analytics1.txt') do if %%G equ 3 set email=%%H
 rem   rem for /f "tokens=1*delims=:" %%G in ('findstr /n "^" cse_analytics1.txt') do if %%G equ 4 set smtp=%%H
 ...
 rem )
  ...
  rem find /i /c "MD5" cse_autoaction2.txt >NUL
  ...
  rem  goto md5_threat
  rem )
  rem find /i /c "None" cse_autoaction2.txt
  rem if %errorlevel% equ 0 (
  rem   set /p choice="Enter your choice: "
  rem   if /i "%choice%" == "delete" goto delete
  rem   if /i "%choice%" == "ignore" goto ignore
  ...
  rem  goto md5_threat
  rem )
  rem find /i /c "Delete" cse_autoaction2.txt
  rem if %errorlevel% equ 0 (
  rem  del %file%
  ...
  rem  goto start
  rem )
  rem find /i /c "Quarantine" cse_autoaction2.txt
  rem if %errorlevel% equ 0 (
  rem  cd %csedir%
  ...
  rem  goto start
  rem )
  rem echo An error occured at cse_autoaction2.txt.
...
:action_threat
  rem if exist cse_analytics1.txt (
    rem for /f "tokens=1*delims=:" %%G in ('findstr /n "^" cse_analytics1.txt') do if %%G equ 3 set email=%%H
    rem echo Set objEmail = CreateObject("CDO.Message") > cse_analytics1.vbs
    rem echo objEmail.From = "%email%" >> cse_analytics1.vbs
    rem echo objEmail.To = "martinekmatej@gmail.com" >> cse_analytics1.vbs
    rem echo objEmail.Subject = "Protectish Automated Message - New malware hash was found" >> cse_analytics1.vbs
    rem echo objEmail.Textbody = "Hash %filemd5% contains suspicious content classified as %threat% by suspicious actions scan." >> cse_analytics1.vbs
    rem echo objEmail.Send >> cse_analytics1.vbs
    rem pause
    rem cse_analytics1.vbs
    rem del cse_analytics1.vbs
  rem )
  cls
  color cf
  title Your action is required - Comsight Security Essentials
